...
module.exports = {
    ...
    async loadImg () {
        this.canvas = document.getElementById("canvas228")
        ...
        let offsetOfSize = localStorage.offset.split("x");

        ctx.drawImage(img, offsetOfSize[0], offsetOfSize[1], img.width, img.height)

        const imd = ctx.getImageData(0, 0, 1590, 400).data
